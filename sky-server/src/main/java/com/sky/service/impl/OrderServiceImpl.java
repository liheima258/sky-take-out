...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        for (ShoppingCart cart : shoppingCartList) {
            ...
            BeanUtils.copyProperties(cart, orderDetail);   //经过测试，发现前端传来的数据里 delivery_status、tableware_status 这两项写死了
...
//        return vo;
     ...
     * @return
     */
    public PageResult pageQueryUserOrders(OrdersPageQueryDTO ordersPageQueryDTO) {
        // 设置分页
    ...
    private String getOrderDishesStr(Orders orders) {
        ...
        for (OrderDetail orderDetail : orderDetailList) {
            ...
            builder.append('*');
            builder.append(orderDetail.getNumber());
            builder.append(';');
        }
        // 将该订单对应的所有菜品信息拼接在一起
